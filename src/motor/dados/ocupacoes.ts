...
export const OCUPACOES: readonly Ocupacao[] = [
  ...
  o({ id: 'feirante', nome: ['feirante', 'feirante'], trilha: 'informal', setor: 'comercio', nivel: 2, salario: 2300, contrato: 'informal', carga: 'integral', idadeMin: 16, oferta: 0, estresse: 3, promocao: 'clientela' }),
  ...
  // ------------------------------------------------------ Água e campo
  o({ id: 'pescador', nome: ['pescador artesanal', 'pescadora artesanal'], trilha: 'pesca', setor: 'agro', nivel: 2, salario: 1900, contrato: 'autonomo', carga: 'integral', idadeMin: 18, lugar: 'agua', oferta: 0, estresse: 3, risco: true, promocao: 'clientela' }),
