...
export interface Ocupacao {
  ...
  /** Jornada que come a vida fora do trabalho. */
  jornada?: 'longa' | 'fora';
...
export const OCUPACOES: readonly Ocupacao[] = [
  ...
  o({ id: 'enfermeiro', nome: ['enfermeiro', 'enfermeira'], trilha: 'enfermagem', setor: 'saude', nivel: 3, salario: 5100, contrato: 'clt', carga: 'integral', idadeMin: 22, area: ['enfermagem'], nivelCurso: 'superior', licenca: 'coren', oferta: 0, estresse: 4, jornada: 'longa', fundamento: 'Lei 7.498/1986: enfermeiro é privativo de bacharel com COREN.' }),
  ...
  o({ id: 'medico', nome: ['médico', 'médica'], trilha: 'medicina', setor: 'saude', nivel: 3, salario: 14500, contrato: 'clt', carga: 'integral', idadeMin: 23, area: ['medicina'], nivelCurso: 'superior', licenca: 'crm', oferta: 0, estresse: 5, jornada: 'longa', fundamento: 'Lei 12.842/2013: exige graduação em Medicina e registro no CRM.' }),
  ...
  o({ id: 'pesquisador', nome: ['pesquisador com bolsa', 'pesquisadora com bolsa'], trilha: 'academia', setor: 'educacao', nivel: 4, salario: 5200, contrato: 'informal', carga: 'integral', idadeMin: 26, area: ['qualquer'], nivelCurso: 'doutorado', entrada: 'oportunidade', oferta: 1, estresse: 3 }),
  ...
  // ------------------------------------------------------ Segurança privada
  o({ id: 'vigilante', nome: ['vigilante', 'vigilante'], trilha: 'vigilancia', setor: 'seguranca', nivel: 1, salario: 2400, contrato: 'clt', carga: 'integral', idadeMin: 21, area: ['vigilancia'], nivelCurso: 'livre', escolaridade: 'fundamental', oferta: 0, estresse: 3, fundamento: 'Lei 7.102/1983: vigilante precisa de 21 anos e curso de formação.' }),

  // ------------------------------------------------------ Forças Armadas
  o({ id: 'soldado_ep', nome: ['soldado do Exército', 'soldado do Exército'], trilha: 'exercito_praca', setor: 'seguranca', nivel: 0, salario: 1500, contrato: 'militar', carga: 'integral', idadeMin: 18, idadeMax: 26, entrada: 'oportunidade', forma: 40, oferta: 0, estresse: 3, promocao: 'antiguidade', anosNoPosto: 1, fundamento: 'Serviço militar obrigatório (Lei 4.375/1964): convocação aos 18; engajamento temporário depois.' }),
  o({ id: 'cabo_ep', nome: ['cabo do Exército', 'cabo do Exército'], trilha: 'exercito_praca', setor: 'seguranca', nivel: 1, salario: 2600, contrato: 'militar', carga: 'integral', idadeMin: 19, idadeMax: 27, entrada: 'oportunidade', oferta: 0, estresse: 3, promocao: 'antiguidade' }),
  o({ id: 'aluno_sargento', nome: ['aluno da escola de sargentos', 'aluna da escola de sargentos'], trilha: 'exercito_sargento', setor: 'seguranca', nivel: 0, salario: 1900, contrato: 'militar', carga: 'integral', idadeMin: 17, idadeMaxIngresso: 24, escolaridade: 'medio', concurso: true, forma: 55, formacaoInicial: { meses: 24, destino: 'sargento' }, oferta: 0, estresse: 4, fundamento: 'Concurso de sargento: ensino médio, teste físico, inspeção de saúde e limite de idade (abstraído como 24 anos).' }),
  ...
  o({ id: 'aluno_pm', nome: ['aluno soldado da PM', 'aluna soldado da PM'], trilha: 'pm', setor: 'seguranca', nivel: 0, salario: 3300, contrato: 'militar', carga: 'integral', idadeMin: 18, idadeMaxIngresso: 30, escolaridade: 'medio', licenca: 'cnh', concurso: true, forma: 55, formacaoInicial: { meses: 12, destino: 'soldado_pm' }, oferta: 0, estresse: 4, fundamento: 'Concurso estadual; escolaridade, CNH e limite de idade variam por estado (abstraídos: médio, CNH, 30 anos).' }),
  o({ id: 'soldado_pm', nome: ['soldado da PM', 'soldado da PM'], trilha: 'pm', setor: 'seguranca', nivel: 2, salario: 5000, contrato: 'militar', carga: 'integral', idadeMin: 19, entrada: 'oportunidade', oferta: 0, estresse: 5, risco: true, promocao: 'antiguidade', anosNoPosto: 6, jornada: 'longa' }),
  ...
  o({ id: 'aluno_bombeiro', nome: ['aluno do curso de bombeiros', 'aluna do curso de bombeiros'], trilha: 'bombeiro', setor: 'seguranca', nivel: 0, salario: 3300, contrato: 'militar', carga: 'integral', idadeMin: 18, idadeMaxIngresso: 30, escolaridade: 'medio', concurso: true, forma: 62, formacaoInicial: { meses: 12, destino: 'bombeiro' }, oferta: 1, estresse: 4, fundamento: 'Concurso estadual com teste físico exigente e limite de idade (abstraído como 30 anos).' }),
  o({ id: 'bombeiro', nome: ['bombeiro militar', 'bombeira militar'], trilha: 'bombeiro', setor: 'seguranca', nivel: 2, salario: 5200, contrato: 'militar', carga: 'integral', idadeMin: 19, entrada: 'oportunidade', oferta: 1, estresse: 4, risco: true, promocao: 'antiguidade', anosNoPosto: 7, jornada: 'longa' }),
  o({ id: 'sargento_bombeiro', nome: ['sargento bombeiro', 'sargento bombeira'], trilha: 'bombeiro', setor: 'seguranca', nivel: 4, salario: 7800, contrato: 'militar', carga: 'integral', idadeMin: 28, entrada: 'oportunidade', experiencia: 120, oferta: 1, estresse: 4, risco: true, promocao: 'antiguidade' }),
  o({ id: 'guarda_municipal', nome: ['guarda municipal', 'guarda municipal'], trilha: 'guarda', setor: 'seguranca', nivel: 2, salario: 3600, contrato: 'servidor', carga: 'integral', idadeMin: 18, escolaridade: 'medio', concurso: true, forma: 45, oferta: 1, estresse: 3, promocao: 'antiguidade' }),
  o({ id: 'policial_civil', nome: ['investigador de polícia', 'investigadora de polícia'], trilha: 'policia_civil', setor: 'seguranca', nivel: 3, salario: 8500, contrato: 'servidor', carga: 'integral', idadeMin: 18, escolaridade: 'superior', concurso: true, forma: 50, oferta: 1, estresse: 5, risco: true, promocao: 'antiguidade', jornada: 'longa' }),
  o({ id: 'delegado', nome: ['delegado de polícia', 'delegada de polícia'], trilha: 'policia_civil', setor: 'seguranca', nivel: 5, salario: 19000, contrato: 'servidor', carga: 'integral', idadeMin: 23, area: ['direito'], nivelCurso: 'superior', concurso: true, forma: 45, oferta: 1, estresse: 5, promocao: 'antiguidade', fundamento: 'Delegado exige bacharelado em Direito (Lei 12.830/2013); alguns estados pedem prática jurídica.' }),
...
export const OCUPACOES_POR_CLASSE: Record<string, string[]> = {
  vulneravel: ['ambulante', 'diarista', 'ajudante_obras', 'trabalhador_rural', 'manicure', 'aux_cozinha', 'entregador_app', 'cuidador', 'estoquista'],
  trabalhadora: ['atendente', 'caixa', 'pedreiro', 'mecanico', 'aux_adm', 'garcom', 'cozinheiro', 'motorista_app', 'cabeleireiro', 'aux_manutencao', 'tec_enfermagem', 'operador_maquinas', 'operador_producao', 'vigilante', 'barbeiro', 'confeiteiro', 'motorista_onibus', 'caminhoneiro'],
  media_baixa: ['vendedor', 'assistente_adm', 'tec_enfermagem', 'eletricista', 'supervisor_loja', 'professor_fund', 'escriturario_banco', 'tecnico_industrial', 'tecnico_publico', 'soldado_pm', 'sargento', 'dono_lanchonete', 'dono_comercio', 'agente_saude', 'produtor_rural', 'guarda_municipal'],
